<template>
  <div class="col-sm-6 col-md-3 product">
    <div class="body">
      ...
      ></a>
      <a href="./"
        ><img :src="domainName + '/' + product.ProductMedia[0].Uri" alt="Image"
      /></a>
...
.product a.favorites[data-favorite="active"] {
  opacity: 1;
